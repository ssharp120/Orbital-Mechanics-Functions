function dCOES = differentiateParametersWithPerturbationsForODE45(T, COES, rbody, mu, vw, J2, J3, Cd, A_xsec, m, min_z)
...
% J3
va_J3_ECI = J3Acceleration(rbody, mu, J3, vr_ECI)';

% Combine perturbations and split into components
va_pert_ECI = va_drag_ECI + va_J2_ECI + va_J3_ECI;
